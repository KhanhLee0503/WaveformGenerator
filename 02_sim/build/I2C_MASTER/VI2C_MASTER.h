...
class VI2C_MASTER___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VI2C_MASTER VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VI2C_MASTER___024root* const rootp;
    ...
    explicit VI2C_MASTER(VerilatedContext* contextp, const char* name = "TOP");
    explicit VI2C_MASTER(const char* name = "TOP");
